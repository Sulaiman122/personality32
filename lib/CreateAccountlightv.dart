...
class CreateAccountlightv extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 138.0, start: 3.0),
                  Pin(size: 92.0, start: 115.0),
                  child: Text(
                    'Create\nAccount.',
                    style: TextStyle(
                ...
                Pinned.fromPins(
                  Pin(size: 38.0, start: 11.0),
                  Pin(size: 21.0, middle: 0.4632),
                  child: Text(
                    'Email',
                    style: TextStyle(
                      fontFamily: 'SF Compact Rounded',
                ...
                Pinned.fromPins(
                  Pin(size: 71.0, start: 11.0),
                  Pin(size: 21.0, middle: 0.3561),
                  child: Text(
                    'Full Name',
                    style: TextStyle(
                      fontFamily: 'SF Compact Rounded',
                ...
                Pinned.fromPins(
                  Pin(size: 116.0, start: 11.0),
                  Pin(size: 21.0, middle: 0.5703),
                  child: Text(
                    'Create Password',
                    style: TextStyle(
                      fontFamily: 'SF Compact Rounded',
                ...
                Pinned.fromPins(
                  Pin(size: 43.0, start: 3.5),
                  Pin(size: 1.0, middle: 0.2875),
                  child: SvgPicture.string(
                    _svg_fxxnq2,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
...
const String _svg_hwl4ub =
    '<svg viewBox="15.0 472.5 345.5 1.0" ><path transform="translate(15.0, 472.5)" d="M 0 0 L 345.5 0" fill="none" stroke="#cccccc" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
